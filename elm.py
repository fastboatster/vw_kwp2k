...
# TODO clean this file up, update licensing info and remove unnecessary functions
...
class Elm327:
    """ Elm327 abstracts the communication with the vehicle."""
    ...
    #  send init commands to elm to get it ready to send and receive CAN messages
    def initialize(self):
    ...
    def RTRV_record(self):
        ...
        # was an AT command or there was line noise in the tracefile
    ...
    def format_obd2_record(self, record):
        ...
        # 5 possibilities:  can/headers,
        # can/no headers/multiline,
        # can/no headers/singleline,
        # old/headers,
        # old/no headers
        if self.debug > 1:
